...
import { useMyMindMaps } from '@/modules/mindmap/hooks/useMyMindMaps';
import MindMapHeader from '@/modules/mindmap/components/MindMapHeader';
import MindMapTabs from '@/modules/mindmap/components/MindMapTabs';

// 使用从types导入的接口
import { SharedMindMap } from '@/modules/mindmap/types/mindmap';
