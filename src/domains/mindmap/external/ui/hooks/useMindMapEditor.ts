...
import { useMindMapData } from '@/modules/mindmap/bridges/hooks';
import { useMindMapNodes } from '@/modules/mindmap/bridges/hooks';
import { useMindMapLayout } from '@/modules/mindmap/bridges/hooks';
import { useMindMapNodeEdit } from '@/modules/mindmap/bridges/hooks';
import { useMindMapConnections } from '@/modules/mindmap/bridges/hooks';

// 创建简单模拟的nodes和edges状态管理hooks
